...
//   function secondTolast(inputArray) {
...
//   function thirdToLast(inputArray) {
...
// // Exercise 71
// // Write a function definition named hasEvens that takes in sequence of numbers
...
// // Exercise 72
// // Write a function definition named countEvens that takes in sequence of numbers
...
// // Exercise 73
// // Write a function definition named hasOdds that takes in sequence of numbers
...
// // Exercise 75
// // Write a function definition named countNegatives that takes in sequence of numbers
...
// // Exercise 77
// // Write a function definition named onlyPositiveEvens that takes in sequence
// of numbers and returns an array containing all the positive evens from the sequence
...
// // Exercise 80
// // Write a function definition named onlyNegativeOdds that takes in sequence
// of numbers and returns an array containing all the negative odd numbers from the sequence
...
// // Exercise 84
// // Write a function definition named elementsTimesTwo that takes in an
// array of numbers
...
// // Exercise 88
// // Write a function named getYearPublished that takes in an objects and returns
// the value behind the "year_published" key.
function getYearPublished(objects){
    return objects.year_published;
}
...
// // Exercise 98
// // Write a function named totalNumberOfItems that takes in the shopping cart as
// input and returns the total number all item quantities.
...
function getAverageItemPrice(shoppingCart){
    let sum = 0;
    let cart = shoppingCart.items.length;
...
function mostSpentOnItem(shoppingCart){
    ...
    for(let i = 0; i < shoppingCart.items.length; i++){
        if(!mostExpensiveItem || (shoppingCart.items[i].price * shoppingCart.items[i].quantity) > (mostExpensiveItem.price * mostExpensiveItem.quantity)){
...
//   var price = 0;
//   var quanity =0;
//   var highest = (Math.max (price * quanity);
//   }
// return highest (price*quanity)
